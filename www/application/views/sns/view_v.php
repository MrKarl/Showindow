...
?>
	...
	<article id="board_area">
		...
		<table cellspacing="0" cellpadding="0" class="table table-striped">
			...
			<tfoot>
				<tr>
					<th colspan="4"><a href="/controlls/lists/page/<?php echo $this->uri->segment(5);?>" class="btn btn-primary">목록</a> <a href="
						/controlls/modify_photo/<?php echo $this->uri->segment(3);?>" class="btn btn-warning">수정</a> <a href="/controlls/delete/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(5);?>" class="btn btn-danger">삭제</a> <a href="/controlls/upload_photo/page/<?php echo $this->uri->segment(5);?>" class="btn btn-success">쓰기</a></th>
				</tr>
			</tfoot>
		</table>
