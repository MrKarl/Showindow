...
<head>
			...
			$('.auto-submit-star').rating({
			 	callback: function(value, link){
				 	...
				 	if(numOfRating > 7){
				 		...
				 		$('#skip').html('<img src="http://54.238.143.240/assets/skip_btn.png" style="cursor:pointer;" onclick="javascript:goToSkip();"/>');
				 	...
				 	if(numOfRating == <?php echo $num_items; ?>){
				 		...
				 		// $('#skip').html('');
				 		if(step == 1){
				 			$('#next').html('<a href="/register/index/2"><img src="http://54.238.143.240/assets/next_button.jpg"/></a>');
				 		}else if(step==2){
							$('#next').html('<a href="/register/index/3"><img src="http://54.238.143.240/assets/next_button.jpg"/></a>');			 			
				 		}else if(gender=="male" && step == 3){
							$('#next').html('<a href="/main"><img src="http://54.238.143.240/assets/next_button.jpg"/></a>');
						}else if(gender=="female" && step == 3){
							$('#next').html('<a href="/register/index/4"><img src="http://54.238.143.240/assets/next_button.jpg"/></a>');
						}else if(gender=="female" && step == 4){
							$('#skip').html('<a href="/main/delaying_index"><img src="http://54.238.143.240/assets/next_button.jpg"/></a>');							
				 		}
				 	}
	...
	<script type="text/javascript">
		function goToSkip(){
			if (confirm("적은 수의 아이템을 평가하시게 되면, 알고리즘의 정확도가 낮아집니다. 그래도 skip하시겠습니까?")){
				location.replace("/main/delaying_index");
			}else{
				//nothing;
			}
		}
